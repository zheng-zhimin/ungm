                        ...
                        <tr>
                          ...
                          <!--   <td>{{ $v['zizhi'] }}</td>
                           ...
                           <!--  <td>
                            ...
                            <form action="/admin/selloffer/{{$v['id']}}" method="post">
                               {{ csrf_field() }}
                               {{ method_field('DELETE') }}
                              ...
                              <div  style="float:left;  margin-right:5px; ">
                             @if( $v['status']==0)
                             <form action="/admin/selloffer/yes/{{$v['id']}}" method="post">
                            {{ csrf_field() }}
                          
                            <input type="submit" id="yes" class="btn btn-success" value="通过" onclick="return confirm('确认要审核通过该供应商的发布信息吗?');" >
                             </form> 
                            @else
                             <form action="/admin/selloffer/no/{{$v['id']}}" method="post">
                               {{ csrf_field() }}

                               <input type="submit" id="no" class="btn btn-danger"  value="撤销" onclick="return confirm('确认撤销该供应商的发布信息吗?');" >
                            </form>
                            @endif
