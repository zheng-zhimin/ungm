      ...
      <!---->
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item nav-item-1 active"> 
                    <a class="nav-link " data-toggle="tab" href="#addProcurement" role="tab" align="center"><span class="zzzzz" style="font-weight: 600;">添加采购（<span>0</span>）</span></a> 
                </li>
                <li class="nav-item nav-item-2"> 
                    <a class="nav-link" data-toggle="tab" href="#released" role="tab" align="center"><span class="hidden-xs-down" style="font-weight: 600;">已发布（<span>0</span>）</span></a> 
                </li>
                <li class="nav-item nav-item-3"> 
                    <a class="nav-link " data-toggle="tab" href="#inReview" role="tab" align="center"><span class="hidden-xs-down" style="font-weight: 600;">审核中（<span>0</span>）</span></a> 
                </li>
                <li class="nav-item nav-item-4"> 
                    <a class="nav-link" data-toggle="tab" href="#notPass" role="tab" align="center"><span class="hidden-xs-down" style="font-weight: 600;">未通过（<span>0</span>）</span></a> 
                </li>
                <li class="nav-item nav-item-5"> 
                    <a class="nav-link " data-toggle="tab" href="#expired" role="tab" align="center"><span class="hidden-xs-down" style="font-weight: 600;">已过期（<span>0</span>）</span></a> 
                </li>
            </ul>
<form action="/home/userinfo/adduser" method="post" enctype="multipart/form-data" >
                <!-- Tab panes -->
                       ...
                       {{ csrf_field() }}
                        ...
                        <div class="row">
                            ...
                            <div class="tex-r uploading col-md-10">
                                <div class="col-md-2">
                                        ...
                                        <input type="file" class="form-control myUpload" name="img">
                                        <img src="/ungmhome/images/个人中心1.png" class="add"/>
                                        <img class="show hide"/>
                                        <p>点击上传</p>
                                        <p><button type="" class="btn btn-default btn-xs">上传记录</button><button type="reset" class="btn btn-default closes btn-xs hide">删除</button></p>
                        ...
                        <div class="row">
                            ...
                            <div class="tex-r col-md-10">
                                <!-- <input type="" name="" class="form-control"><img> -->
                                <input type="date" name="deadline" class="form-control">
                                <span>不选表示长期有效</span>
                            </div>
                        </div>
                        <div class="row">
                            <span class="tex col-md-1">交易条件</span>
                         <div class="tex-r col-md-10">
                             <div class="l-r-tex"><span>过期时间</span>
                             <input type="date" name="" class="form-control"></div>
                             <div><span>价格要求</span>
                             <input type="" name="price" class="form-control"></div>
                            <!--  <div><span>包装要求</span>
