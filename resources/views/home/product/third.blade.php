...
<div class="ABC">
                ...
                <div class="twoMRO">
                    <div class="ltMRO">
                        <h1><a href="/home/productdetail/241">广州电动平衡车维修,广州电动平衡车批发</a></h1>
                        <div class="">
                            <ul>
                                <li><label for="">供货数量</label><input type="text" readonly  value="暂无数据"></li>
                                <li class="threeMRO"><label for="">最少起订</label><input readonly type="text" value="暂无数据"></li>
                                <li><label for="">型号</label><input readonly  type="text" value="暂无数据"></li>
                                <li class="threeMRO"><label for="">暂无数据</label><input readonly type="text" value="暂无数据"></li>
                                <li class="fourMRO"><label for="">工作电压</label><input  readonly type="text" value="暂无数据"></li>
                                <li class="threeMRO fourMRO"><label for="">类型</label><input readonly type="text" value="暂无数据"></li>
                            </ul>
                        </div>
                        <p>更新时间： 暂无数据  </p>
                    </div>
