...
.animate-floa-1{
  -webkit-animation: floa-1 2.6s linear infinite;
  animation: floa-1 2.6s linear infinite;
}
/* --2-- */
@-webkit-keyframes floa-2{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-2{
  -webkit-animation: floa-2 3s linear infinite;
  animation: floa-2 3s linear infinite;
}
/* --3-- */
@-webkit-keyframes floa-3{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-3{
  -webkit-animation: floa-3 1.9s linear infinite;
  animation: floa-3 1.9s linear infinite;
}
/* --4-- */
@-webkit-keyframes floa-4{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-4{
  -webkit-animation: floa-4 1.8s linear infinite;
  animation: floa-4 1.8s linear infinite;
}
/* --5-- */
@-webkit-keyframes floa-5{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-5{
  -webkit-animation: floa-5 2.3s linear infinite;
  animation: floa-5 2.3s linear infinite;
}
/* --6-- */
@-webkit-keyframes floa-7{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-7{
  -webkit-animation: floa-7 2.8s linear infinite;
  animation: floa-7 2.8s linear infinite;
}
/* --8-- */
@-webkit-keyframes floa-8{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-8{
  -webkit-animation: floa-8 2.5s linear infinite;
  animation: floa-8 2.5s linear infinite;
}
/* --9-- */
@-webkit-keyframes floa-9{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-9{
  -webkit-animation: floa-9 1.9s linear infinite;
  animation: floa-9 1.9s linear infinite;
}
/* --10-- */
@-webkit-keyframes floa-10{
  25% {
    -webkit-transform: translateY(-10px);
  }
  50%, 100% {
...
.animate-floa-10{
  -webkit-animation: floa-10 2s linear infinite;
  animation: floa-10 2s linear infinite;
}
    </style>
...
<body>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            <div class="swiper-slide swiper-slide-1" style="">
                <canvas id="stars"></canvas>
                <a class="btn btn-success" href="/" style="position: absolute;top:41px;text-align: left;right:80px;color:#fff;text-decoration: none;">返回首页</a>
                <div class="text" style="position: absolute;top:110px;text-align: left;left:300px;">
                    <div id="divTyping" class="aa">
                        
                    </div>
                    <div id="divTyping1" class="aa tex-md">
                        
                    </div>
                    <div id="divTyping2" class="aa tex-md">
                        
                    </div>
                    <div id="divTyping3" class="aa tex-md">
                        
                    </div>
                    <div id="divTyping4" class="aa tex-eng">
                        
                    </div>
                    <div id="divTyping5" class="aa tex-aa">
                        
                    </div>
                    <div id="divTyping6" class="aa tex-md">
                    
                    </div>  
                    <div id="divTyping7" class="aa tex-md">
                        
                    </div>
                    <div id="divTyping8" class="aa tex-eng">
            ...
            <div class="swiper-slide swiper-slide-2">
                ...
                <div class="h-tex" style="position: absolute;top:358px;text-align:center;">
                    ...
                    <p class="p1">2、企业在国家工商部门登记年营业额超过4亿以上</p>
                    <img src="/ungmhome/images/邮箱按钮.png" >
                </div>
   ...
   var b = 0;
   function typing1(){
    var divTyping = document.getElementById('divTyping1');

    if (b <= str1.length) {
     divTyping.innerHTML = str1.slice(0, b++)
     setTimeout('typing1()', 110);//递归调用
    }
    else{
   ...
   var c = 0;
   function typing2(){
    var divTyping = document.getElementById('divTyping2');

    if (c <= str2.length) {
     divTyping.innerHTML = str2.slice(0, c++);
     setTimeout('typing2()', 100);//递归调用
    }
    else{
    ...
    var str3 = '集客是一个人人想进的圈子';
   var d = 0;
   function typing3(){
    var divTyping = document.getElementById('divTyping3');

    if (d <= str3.length) {
     divTyping.innerHTML = str3.slice(0, d++);
     setTimeout('typing3()', 80);//递归调用
    }
    else{
   ...
   var str4 = 'A high circle that everyone wants to be in';
   var e = 0;
   function typing4(){
    var divTyping = document.getElementById('divTyping4');

    if (e <= str4.length) {
     divTyping.innerHTML = str4.slice(0, e++);
     setTimeout('typing4()', 10);//递归调用
    }
    else{
   ...
   var f = 0;
   function typing5(){
    var divTyping = document.getElementById('divTyping5');

    if (f <= str5.length) {
     divTyping.innerHTML = str5.slice(0, f++);
     setTimeout('typing5()', 140);//递归调用
    }
    else{
   ...
   var g = 0;
   function typing6(){
    var divTyping = document.getElementById('divTyping6');

    if (g <= str6.length) {
     divTyping.innerHTML = str6.slice(0, g++);
     setTimeout('typing6()', 100);//递归调用
    }
    else{
     divTyping.innerHTML = str6;
     g = 0;//结束打字,移除 _ 光标
     typing7();
    }
   };
   ...
   var g = 0;
   function typing7(){
    var divTyping = document.getElementById('divTyping7');

    if (g <= str7.length) {
     divTyping.innerHTML = str7.slice(0, g++);
     setTimeout('typing7()', 80);//递归调用
    }
    else{
     divTyping.innerHTML = str7;
     g = 0;//结束打字,移除 _ 光标
     typing8();
    }
   };

   var str8 = 'What can a collector do';
   var h = 0;
   function typing8(){
    var divTyping = document.getElementById('divTyping8');

    if (h <= str8.length) {
     divTyping.innerHTML = str8.slice(0, h++);
     setTimeout('typing8()', 10);//递归调用
    }
    else{
     divTyping.innerHTML = str8;
     h = 0;//结束打字,移除 _ 光标
    }
   };
   ...
   function typing(){
    ...
    if (a <= str.length) {
     divTyping.innerHTML = str.slice(0, a++);
   ...
   // typing();
        typing();
        setInterval(typing,11500);
  </script>
    <script src="/ungmhome/js/jquery-ui.min.js"></script>
    <!-- Initialize Swiper -->
    <script>
